...
def equation_builder( components, printing = 'off' ):
    ...
    for equation_id in target_equations:
        ...
        rhs= Add()                                  # Empty right hand side

        lhs = Add()                                 # Empty left hand side
        ...
        for c_variable in variables:
            ...
            if len( c_variable.id().split('_') ) > 2 :
                ...
                cv_eq_id = c_variable.id().split('_')[2].split('.')[0]              # This is the equation ID of the concentration variable
    ...
    if printing == 'on' or printing == 'On' or printing == 'ON':
        ...
        printer( equations_display, 'The simple equations for non-initial value compounds are:' )
